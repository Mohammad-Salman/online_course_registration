...
<title>Northern University Bangladesh | Admin-Home</title>
</head>
<style>
  div.card-1, div.card-2, div.card-3{width: 89%; margin:7% 5%; float: left; border: 3px solid grey;}
	...
	@media only screen and (min-width: 769px) {
		...
		div.card-1{width: 26.5%; margin:5% 1.3% 15% 7%; border: 0;}
		div.card-2{width: 26.5%; margin:5% 1.3%; border: 0;}
		div.card-3{width: 26.5%; margin:5% 7% 15% 1.3%; border: 0;}
...
<body class="w3-leftbar w3-rightbar w3-border-dark-grey" id="content-container">
    ...
    <h1 id="semester-name" class="w3-animate-right">Administration Panel</h1>

    <div class="">
      <!--1'st card-->
      <a href="http://localhost/web_programming/pac_generate.php">
        <div class="hover-shadow-16 card-1">
          <img src= "nub_web_images/looking_up_at_buildings-wallpaper-1366x768.jpg" style="width:100%; height:100%;"/>
          <div class="w3-container" style="padding: 11% 7%;">
            <b>Package Generation</b>
            <p>Click on it.</p>
          </div>
        </div>
      </a>
      <!--2'nd card-->
      <a href="http://localhost/web_programming/reg_approve.php">
        <div class="hover-shadow-16 card-2">
          <img src= "nub_web_images/looking_up_at_buildings-wallpaper-1366x768.jpg" style="width:100%; height:100%;"/>
          <div class="w3-container" style="padding: 11% 7%;">
            <b>Registration Approve</b>
            <p>Click on it.</p>
          </div>
        </div>
      </a>
      <!--3'rd card-->
      <a href="http://localhost/web_programming/result_publish.php">
	...
	<div class="w3-center w3-padding-32" style="margin-top: 11%;">
      ...
      <li><a class="w3-hover-black" href="http://localhost/web_programming/pac_generate.php"><i class="fa fa-angle-double-right"></i></a></li>
		</ul>
	</div>
