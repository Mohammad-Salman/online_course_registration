...
<title>Northern University Bangladesh | Registration Package</title>
<style>
	li a{
		cursor: pointer;
	}
...
<body>
	...
	<div class=" w3-large w3-red w3-padding-large">
		<ul class="w3-navbar">
			...
			<li><a class="w3-blue" href="http://localhost/web_programming/registration_package.php">Registration Package</a></li>
	...
	<div class="w3-center w3-padding-32" style="margin-top: 11%;">
		<ul class="w3-pagination">
			<li><a class="w3-hover-black" href="http://localhost/web_programming/home.php"><i class="fa fa-angle-double-left"></i></a></li>
			...
			<li><a class="w3-hover-black" href="http://localhost/web_programming/course_registration.php"><i class="fa fa-angle-double-right"></i></a></li>
		</ul>
	</div>
